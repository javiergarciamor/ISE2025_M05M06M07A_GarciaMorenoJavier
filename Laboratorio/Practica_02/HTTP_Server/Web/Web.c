...
/* Last-Modified: Mon, 10 Mar 2025 18:37:32 GMT */
const uint32_t imageLastModified = 1741631852U;

static const uint8_t imageFileData[25599U] = {
...
static const imageFileItem imageFileTable[19U+1U] = {
  ...
  { 0xCEC97D75U, &imageFileData[11297U] },    // "network.cgi"
  { 0x69E9F01DU, &imageFileData[13445U] },    // "system.cgi"
  { 0x5579E5A7U, &imageFileData[14696U] },    // "tcp.cgi"
  { 0xEEA8CB3DU, &imageFileData[15340U] },    // "xml_http.js"
  { 0xDE703953U, &imageFileData[18156U] },    // "home.png"
  { 0x90CE4E8AU, &imageFileData[19545U] },    // "keil.gif"
  { 0xA35A02C8U, &imageFileData[20683U] },    // "logo.gif"
  { 0x7049A0E1U, &imageFileData[22470U] },    // "llblue.jpg"
  { 0x3BDBDB05U, &imageFileData[25478U] },    // "pabb.gif"
  { 0x00000000U, &imageFileData[25599U] }
};
