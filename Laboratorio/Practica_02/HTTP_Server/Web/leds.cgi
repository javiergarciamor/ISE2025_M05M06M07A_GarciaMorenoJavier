...
c b 2 <td><input type=checkbox name=led2 OnClick="submit();" %s>LED 3</td>
c b 1 <td><input type=checkbox name=led1 OnClick="submit();" %s>LED 2</td>
c b 0 <td><input type=checkbox name=led0 OnClick="submit();" %s>LED 1</td>
t </font></table></td></tr>
