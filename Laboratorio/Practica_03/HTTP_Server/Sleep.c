...
osTimerId_t tim_id_15s;
 
void Th_sleep (void *argument);                   // thread function

static void Timer_Callback_15s(void const *arg){
...
int Init_Th_sleep (void) {
  ...
  tid_sleep= osThreadNew(Th_sleep, NULL, NULL);
  if (tid_sleep == NULL) {
    return(-1);
  }
